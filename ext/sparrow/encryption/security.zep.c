...
{
	ZEPHIR_REGISTER_CLASS_EX(Sparrow\\Encryption, Security, sparrow, encryption_security, zephir_get_internal_ce(SL("phalcon\\di\\abstractinjectionaware")), sparrow_encryption_security_method_entry, 0);

	/**
	 * @var int
	 */
	zend_declare_property_long(sparrow_encryption_security_ce, SL("defaultHash"), 0, ZEND_ACC_PROTECTED);
	/**
	 * @var int
	 */
	zend_declare_property_long(sparrow_encryption_security_ce, SL("numberBytes"), 16, ZEND_ACC_PROTECTED);
	/**
	 * @var Random
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("random"), ZEND_ACC_PROTECTED);
	/**
	 * @var string|null
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("requestToken"), ZEND_ACC_PROTECTED);
	/**
	 * @var string|null
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("token"), ZEND_ACC_PROTECTED);
	/**
	 * @var string|null
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("tokenKey"), ZEND_ACC_PROTECTED);
	/**
	 * @var string
	 */
	zend_declare_property_string(sparrow_encryption_security_ce, SL("tokenKeySessionId"), "$PHALCON/CSRF/KEY$", ZEND_ACC_PROTECTED);
	/**
	 * @var string
	 */
	zend_declare_property_string(sparrow_encryption_security_ce, SL("tokenValueSessionId"), "$PHALCON/CSRF$", ZEND_ACC_PROTECTED);
	/**
	 * @var int
	 */
	zend_declare_property_long(sparrow_encryption_security_ce, SL("workFactor"), 10, ZEND_ACC_PROTECTED);
	/**
	 * @var SessionInterface|null
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("localSession"), ZEND_ACC_PRIVATE);
	/**
	 * @var RequestInterface|null
	 */
	zend_declare_property_null(sparrow_encryption_security_ce, SL("localRequest"), ZEND_ACC_PRIVATE);
	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_ARGON2I"), 10);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_ARGON2ID"), 11);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_BCRYPT"), 0);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_DEFAULT"), 0);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_BLOWFISH"), 4);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_BLOWFISH_A"), 5);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_BLOWFISH_X"), 6);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_BLOWFISH_Y"), 7);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_EXT_DES"), 2);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_MD5"), 3);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_SHA256"), 8);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_SHA512"), 9);

	zephir_declare_class_constant_long(sparrow_encryption_security_ce, SL("CRYPT_STD_DES"), 1);
...
PHP_METHOD(Sparrow_Encryption_Security, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, sparrow_encryption_security_random_ce);
...
PHP_METHOD(Sparrow_Encryption_Security, computeHmac)
{
	...
	if (UNEXPECTED(!zephir_is_true(&hmac))) {
		...
		object_init_ex(&_1$$3, sparrow_encryption_security_exception_ce);
