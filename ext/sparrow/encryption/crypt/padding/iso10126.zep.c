...
{
	ZEPHIR_REGISTER_CLASS(Sparrow\\Encryption\\Crypt\\Padding, Iso10126, sparrow, encryption_crypt_padding_iso10126, sparrow_encryption_crypt_padding_iso10126_method_entry, 0);

	zend_class_implements(sparrow_encryption_crypt_padding_iso10126_ce, 1, sparrow_encryption_crypt_padding_padinterface_ce);
	return SUCCESS;
}
