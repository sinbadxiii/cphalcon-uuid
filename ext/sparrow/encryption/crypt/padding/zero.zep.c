...
{
	ZEPHIR_REGISTER_CLASS(Sparrow\\Encryption\\Crypt\\Padding, Zero, sparrow, encryption_crypt_padding_zero, sparrow_encryption_crypt_padding_zero_method_entry, 0);

	zend_class_implements(sparrow_encryption_crypt_padding_zero_ce, 1, sparrow_encryption_crypt_padding_padinterface_ce);
	return SUCCESS;
}
