...
{
	ZEPHIR_REGISTER_CLASS(Sparrow\\Encryption\\Crypt\\Padding, Pkcs7, sparrow, encryption_crypt_padding_pkcs7, sparrow_encryption_crypt_padding_pkcs7_method_entry, 0);

	zend_class_implements(sparrow_encryption_crypt_padding_pkcs7_ce, 1, sparrow_encryption_crypt_padding_padinterface_ce);
	return SUCCESS;
}
