...
{
	ZEPHIR_REGISTER_CLASS_EX(Sparrow\\Encryption\\Security\\Uuid, Uuid3, sparrow, encryption_security_uuid_uuid3, sparrow_encryption_security_uuid_ce, sparrow_encryption_security_uuid_uuid3_method_entry, 0);

	zephir_declare_class_constant_long(sparrow_encryption_security_uuid_uuid3_ce, SL("TYPE"), 3);
