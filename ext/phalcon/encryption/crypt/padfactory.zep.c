...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Encryption\\Crypt, PadFactory, phalcon, encryption_crypt_padfactory, zephir_get_internal_ce(SL("phalcon\\factory\\abstractfactory")), phalcon_encryption_crypt_padfactory_method_entry, 0);
