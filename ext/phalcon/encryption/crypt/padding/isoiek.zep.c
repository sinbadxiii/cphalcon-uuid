...
PHP_METHOD(Phalcon_Encryption_Crypt_Padding_IsoIek, pad)
{
	...
	ZVAL_LONG(&_0, 0x80);
	ZEPHIR_CALL_FUNCTION(&_1, "chr", NULL, 25, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_FUNCTION(&_2, "chr", NULL, 25, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, (paddingSize - 1));
	ZEPHIR_CALL_FUNCTION(&_3, "str_repeat", NULL, 26, &_2, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt_Padding_IsoIek, unpad)
{
	...
	paddingSize = 0;
	ZEPHIR_CALL_FUNCTION(&length, "mb_strlen", NULL, 12, &input);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&inputArray, "str_split", NULL, 29, &input);
	zephir_check_call_status();
	...
	while (1) {
		...
		if (_0) {
			...
			ZVAL_LONG(&_2, 0);
			ZEPHIR_CALL_FUNCTION(&_3, "chr", &_4, 25, &_2);
			zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 0x80);
	ZEPHIR_CALL_FUNCTION(&_7, "chr", &_4, 25, &_2);
	zephir_check_call_status();
