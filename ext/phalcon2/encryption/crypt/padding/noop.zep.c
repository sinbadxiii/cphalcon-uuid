...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Crypt\\Padding, Noop, phalcon2, encryption_crypt_padding_noop, phalcon2_encryption_crypt_padding_noop_method_entry, 0);

	zend_class_implements(phalcon2_encryption_crypt_padding_noop_ce, 1, phalcon2_encryption_crypt_padding_padinterface_ce);
	return SUCCESS;
}
