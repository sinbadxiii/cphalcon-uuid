 ...
 * Class IsoIek
 *
 * @package Phalcon2\Encryption\Crypt\Padding
 */
ZEPHIR_INIT_CLASS(Phalcon2_Encryption_Crypt_Padding_IsoIek)
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Crypt\\Padding, IsoIek, phalcon2, encryption_crypt_padding_isoiek, phalcon2_encryption_crypt_padding_isoiek_method_entry, 0);

	zend_class_implements(phalcon2_encryption_crypt_padding_isoiek_ce, 1, phalcon2_encryption_crypt_padding_padinterface_ce);
	return SUCCESS;
}
 ...
 * @return string
 */
PHP_METHOD(Phalcon2_Encryption_Crypt_Padding_IsoIek, pad)
{
	...
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_FUNCTION(&_2, "chr", NULL, 42, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, (paddingSize - 1));
	ZEPHIR_CALL_FUNCTION(&_3, "str_repeat", NULL, 43, &_2, &_0);
	zephir_check_call_status();
 ...
 * @return int
 */
PHP_METHOD(Phalcon2_Encryption_Crypt_Padding_IsoIek, unpad)
{
	zend_bool _0, _5;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	while (1) {
		_0 = counter > 0;
		if (_0) {
			zephir_array_fetch_long(&_1, &inputArray, counter, PH_NOISY | PH_READONLY, "phalcon2/Encryption/Crypt/Padding/IsoIek.zep", 48);
			ZVAL_LONG(&_2, 0);
	...
	zephir_array_fetch_long(&_6, &inputArray, counter, PH_NOISY | PH_READONLY, "phalcon2/Encryption/Crypt/Padding/IsoIek.zep", 55);
	ZVAL_LONG(&_2, 0x80);
	ZEPHIR_CALL_FUNCTION(&_7, "chr", &_4, 42, &_2);
	zephir_check_call_status();
