...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Security\\JWT, Validator, phalcon2, encryption_security_jwt_validator, phalcon2_encryption_security_jwt_validator_method_entry, 0);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_validator_ce, SL("claims"), ZEND_ACC_PRIVATE);
	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_validator_ce, SL("errors"), ZEND_ACC_PRIVATE);
	/**
	 * @var int
	 */
	zend_declare_property_long(phalcon2_encryption_security_jwt_validator_ce, SL("timeShift"), 0, ZEND_ACC_PRIVATE);
	/**
	 * @var Token
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_validator_ce, SL("token"), ZEND_ACC_PRIVATE);
	phalcon2_encryption_security_jwt_validator_ce->create_object = zephir_init_properties_Phalcon2_Encryption_Security_JWT_Validator;
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Validator, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(1, 2)
		Z_PARAM_OBJECT_OF_CLASS(token, phalcon2_encryption_security_jwt_token_token_ce)
		Z_PARAM_OPTIONAL
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Validator, get)
{
	...
	if (zephir_array_isset(&_0, &claim)) {
		...
		zephir_array_fetch(&_2$$3, &_1$$3, &claim, PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/JWT/Validator.zep", 75);
		RETURN_CTOR(&_2$$3);
	}
	RETURN_MM_NULL();
}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Validator, validateAudience)
{
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Audience must be a string or an array", "phalcon2/Encryption/Security/JWT/Validator.zep", 113);
		return;
	}
	...
	zephir_check_call_status();
	zephir_is_iterable(audience, 0, "phalcon2/Encryption/Security/JWT/Validator.zep", 128);
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Validator, validateExpiration)
{
	...
	if (_7) {
		...
		ZEPHIR_CALL_METHOD(&_8, this_ptr, "gettimestamp", NULL, 54, &_9);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Validator, validateIssuedAt)
{
	...
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "gettimestamp", NULL, 54, &_5);
	zephir_check_call_status();
