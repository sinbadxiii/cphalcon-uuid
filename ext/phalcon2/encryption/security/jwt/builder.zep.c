...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Security\\JWT, Builder, phalcon2, encryption_security_jwt_builder, phalcon2_encryption_security_jwt_builder_method_entry, 0);

	/**
	 * @var CollectionInterface
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_builder_ce, SL("claims"), ZEND_ACC_PRIVATE);
	/**
	 * @var CollectionInterface
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_builder_ce, SL("jose"), ZEND_ACC_PRIVATE);
	/**
	 * @var string
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_builder_ce, SL("passphrase"), ZEND_ACC_PRIVATE);
	/**
	 * @var SignerInterface
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_builder_ce, SL("signer"), ZEND_ACC_PRIVATE);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(signer, phalcon2_encryption_security_jwt_signer_signerinterface_ce)
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, init)
{
	...
	ZEPHIR_INIT_NVAR(&_0);
	object_init_ex(&_0, zephir_get_internal_ce(SL("phalcon\\support\\collection")));
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("claims"), &_0);
	ZEPHIR_INIT_VAR(&_1);
	object_init_ex(&_1, zephir_get_internal_ce(SL("phalcon\\support\\collection")));
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, getToken)
{
	...
	if (ZEPHIR_IS_EMPTY(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Invalid passphrase (empty)", "phalcon2/Encryption/Security/JWT/Builder.zep", 192);
		return;
	}
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getclaims", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "encode", NULL, 39, &_2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&encodedClaims, this_ptr, "encodeurl", NULL, 40, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&claims);
	object_init_ex(&claims, phalcon2_encryption_security_jwt_token_item_ce);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getclaims", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &claims, "__construct", NULL, 41, &_3, &encodedClaims);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "encode", NULL, 39, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&encodedHeaders, this_ptr, "encodeurl", NULL, 40, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&headers);
	object_init_ex(&headers, phalcon2_encryption_security_jwt_token_item_ce);
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &headers, "__construct", NULL, 41, &_6, &encodedHeaders);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&encodedSignature, this_ptr, "encodeurl", NULL, 40, &signatureHash);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&signature);
	object_init_ex(&signature, phalcon2_encryption_security_jwt_token_signature_ce);
	ZEPHIR_CALL_METHOD(NULL, &signature, "__construct", NULL, 42, &signatureHash, &encodedSignature);
	zephir_check_call_status();
	object_init_ex(return_value, phalcon2_encryption_security_jwt_token_token_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 43, &headers, &claims, &signature);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, setAudience)
{
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Invalid Audience", "phalcon2/Encryption/Security/JWT/Builder.zep", 242);
		return;
	}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, setExpirationTime)
{
	...
	if (ZEPHIR_GT_LONG(&_0, timestamp)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Invalid Expiration Time", "phalcon2/Encryption/Security/JWT/Builder.zep", 287);
		return;
	}
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "exp");
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, setNotBefore)
{
	...
	if (ZEPHIR_LT_LONG(&_0, timestamp)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Invalid Not Before", "phalcon2/Encryption/Security/JWT/Builder.zep", 361);
		return;
	}
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "nbf");
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, setPassphrase)
{
	...
	if (!(zephir_is_true(&_2))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_security_jwt_exceptions_validatorexception_ce, "Invalid passphrase (too weak)", "phalcon2/Encryption/Security/JWT/Builder.zep", 399);
		return;
	}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, encodeUrl)
{
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "-_");
	ZEPHIR_CALL_FUNCTION(&_3, "strtr", NULL, 7, &_0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "=");
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Builder, encode)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "json_last_error", NULL, 44);
	zephir_check_call_status();
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_2, 0))) {
		ZEPHIR_INIT_VAR(&_3$$3);
		object_init_ex(&_3$$3, spl_ce_InvalidArgumentException);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "json_last_error_msg", NULL, 45);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_5$$3);
		ZEPHIR_CONCAT_SV(&_5$$3, "json_encode error: ", &_4$$3);
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 46, &_5$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "phalcon2/Encryption/Security/JWT/Builder.zep", 446);
		ZEPHIR_MM_RESTORE();
		return;
	}
