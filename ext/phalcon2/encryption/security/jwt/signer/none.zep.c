...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Security\\JWT\\Signer, None, phalcon2, encryption_security_jwt_signer_none, phalcon2_encryption_security_jwt_signer_none_method_entry, 0);

	zend_class_implements(phalcon2_encryption_security_jwt_signer_none_ce, 1, phalcon2_encryption_security_jwt_signer_signerinterface_ce);
	return SUCCESS;
}
