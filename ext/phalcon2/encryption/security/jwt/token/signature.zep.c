 ...
 */
ZEPHIR_INIT_CLASS(Phalcon2_Encryption_Security_JWT_Token_Signature)
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security\\JWT\\Token, Signature, phalcon2, encryption_security_jwt_token_signature, phalcon2_encryption_security_jwt_token_abstractitem_ce, phalcon2_encryption_security_jwt_token_signature_method_entry, 0);
 ...
 */
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Token_Signature, __construct)
{
 ...
 * @return string
 */
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Token_Signature, getHash)
{
	zval _0, _1;
	zval *this_ptr = getThis();
	...
	zephir_array_fetch_string(&_1, &_0, SL("hash"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/JWT/Token/Signature.zep", 35);
	RETURN_CTORW(&_1);
}
