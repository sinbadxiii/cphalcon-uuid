...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption\\Security\\JWT\\Token, Token, phalcon2, encryption_security_jwt_token_token, phalcon2_encryption_security_jwt_token_token_method_entry, 0);

	/**
	 * @var Item
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_token_token_ce, SL("claims"), ZEND_ACC_PRIVATE);
	/**
	 * @var Item
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_token_token_ce, SL("headers"), ZEND_ACC_PRIVATE);
	/**
	 * @var Signature
	 */
	zend_declare_property_null(phalcon2_encryption_security_jwt_token_token_ce, SL("signature"), ZEND_ACC_PRIVATE);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(3, 3)
		...
		Z_PARAM_OBJECT_OF_CLASS(claims, phalcon2_encryption_security_jwt_token_item_ce)
		Z_PARAM_OBJECT_OF_CLASS(signature, phalcon2_encryption_security_jwt_token_signature_ce)
...
PHP_METHOD(Phalcon2_Encryption_Security_JWT_Token_Token, validate)
{
	...
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(validator, phalcon2_encryption_security_jwt_validator_ce)
	ZEND_PARSE_PARAMETERS_END();
#endif
	...
	zephir_is_iterable(&methods, 0, "phalcon2/Encryption/Security/JWT/Token/Token.zep", 121);
