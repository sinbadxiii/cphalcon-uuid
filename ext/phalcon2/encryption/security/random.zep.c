...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security, Random, phalcon2, encryption_security_random, phalcon2_encryption_security_binarybase_ce, phalcon2_encryption_security_random_method_entry, 0);
