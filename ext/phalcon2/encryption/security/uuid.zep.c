...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security, Uuid, phalcon2, encryption_security_uuid, phalcon2_encryption_security_binarybase_ce, phalcon2_encryption_security_uuid_method_entry, 0);

	zend_declare_property_null(phalcon2_encryption_security_uuid_ce, SL("uid"), ZEND_ACC_PROTECTED);
	zephir_declare_class_constant_long(phalcon2_encryption_security_uuid_ce, SL("TIME_OFFSET_INT"), 0x01B21DD213814000);

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("TIME_OFFSET_BIN"), "\x01\xb2\x1d\xd2\x13\x81\x40\x00");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("NIL"), "00000000-0000-0000-0000-000000000000");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("MAX"), "ffffffff-ffff-ffff-ffff-ffffffffffff");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("NAMESPACE_DNS"), "6ba7b810-9dad-11d1-80b4-00c04fd430c8");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("NAMESPACE_URL"), "6ba7b811-9dad-11d1-80b4-00c04fd430c8");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("NAMESPACE_OID"), "6ba7b812-9dad-11d1-80b4-00c04fd430c8");

	zephir_declare_class_constant_string(phalcon2_encryption_security_uuid_ce, SL("NAMESPACE_X500"), "6ba7b814-9dad-11d1-80b4-00c04fd430c8");
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, mac)
{
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_6, &parsed, SL("version"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 44);
	if (!ZEPHIR_IS_LONG_IDENTICAL(&_6, 1)) {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_ce_value_error, "mac(): Argument #1 ($uuid) UUID DCE TIME expected", "phalcon2/Encryption/Security/Uuid.zep", 49);
		return;
	}
	zephir_array_fetch_string(&_8, &parsed, SL("node"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 52);
	ZEPHIR_INIT_VAR(&_9);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, v1)
{
	...
	object_init_ex(return_value, phalcon2_encryption_security_uuid_uuid1_ce);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, v3)
{
	...
	object_init_ex(return_value, phalcon2_encryption_security_uuid_uuid3_ce);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, v4)
{
	...
	object_init_ex(return_value, phalcon2_encryption_security_uuid_uuid4_ce);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, v5)
{
	...
	object_init_ex(return_value, phalcon2_encryption_security_uuid_uuid5_ce);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, v6)
{
	...
	object_init_ex(return_value, phalcon2_encryption_security_uuid_uuid6_ce);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, parse)
{
	...
	zephir_array_fetch_string(&_3, &matches, SL("time_hi"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 89);
	zephir_array_fetch_string(&_4, &matches, SL("time_mid"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 89);
	zephir_array_fetch_string(&_5, &matches, SL("time_low"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 89);
	ZEPHIR_INIT_VAR(&_6);
	ZEPHIR_CONCAT_SVVV(&_6, "0", &_3, &_4, &_5);
	zephir_array_update_string(return_value, SL("time"), &_6, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_string(&_7, &matches, SL("version"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 90);
	ZEPHIR_CALL_FUNCTION(&_8, "hexdec", NULL, 17, &_7);
	zephir_check_call_status();
	zephir_array_update_string(return_value, SL("version"), &_8, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_string(&_9, &matches, SL("clock_seq"), PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 91);
	ZEPHIR_CALL_FUNCTION(&_8, "hexdec", NULL, 17, &_9);
	zephir_check_call_status();
	zephir_array_update_string(return_value, SL("clock_seq"), &_8, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_VAR(&_10);
	zephir_array_fetch_string(&_10, &matches, SL("node"), PH_NOISY, "phalcon2/Encryption/Security/Uuid.zep", 93);
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid, hexToDateTime)
{
	...
	if (9 > zephir_fast_strlen_ev(time)) {
		...
		zephir_array_fetch_long(&_4$$3, time, 0, PH_NOISY | PH_READONLY, "phalcon2/Encryption/Security/Uuid.zep", 113);
