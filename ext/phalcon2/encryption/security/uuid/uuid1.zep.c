...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security\\Uuid, Uuid1, phalcon2, encryption_security_uuid_uuid1, phalcon2_encryption_security_uuid_ce, phalcon2_encryption_security_uuid_uuid1_method_entry, 0);

	zend_declare_property_null(phalcon2_encryption_security_uuid_uuid1_ce, SL("clockSeq"), ZEND_ACC_PRIVATE|ZEND_ACC_STATIC);
	zephir_declare_class_constant_long(phalcon2_encryption_security_uuid_uuid1_ce, SL("TYPE"), 1);

	zend_class_implements(phalcon2_encryption_security_uuid_uuid1_ce, 1, phalcon2_encryption_security_uuid_timebaseduidinterface_ce);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon2_Encryption_Security_Uuid_Uuid1, __construct)
{
	...
	zval *uuid_param = NULL, *node_param = NULL, __$false, time$$3, _0$$3, _1$$3, _2$$3, _3$$3, _4$$3, _5$$3, _6$$3, _7$$3, _8$$3, _9$$3, clockSeq$$3, node$$3, _14$$3, _15$$3, _16$$3, _17$$3, _18$$3, _19$$3, _20$$3, _21$$3, _10$$5, _11$$6, _12$$6, _13$$7;
	zval uuid, node;
