...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security\\Uuid, Uuid6, phalcon2, encryption_security_uuid_uuid6, phalcon2_encryption_security_uuid_ce, phalcon2_encryption_security_uuid_uuid6_method_entry, 0);

	zend_declare_property_null(phalcon2_encryption_security_uuid_uuid6_ce, SL("node"), ZEND_ACC_PRIVATE|ZEND_ACC_STATIC);
	zephir_declare_class_constant_long(phalcon2_encryption_security_uuid_uuid6_ce, SL("TYPE"), 1);

	zend_class_implements(phalcon2_encryption_security_uuid_uuid6_ce, 1, phalcon2_encryption_security_uuid_timebaseduidinterface_ce);
	return SUCCESS;
}
