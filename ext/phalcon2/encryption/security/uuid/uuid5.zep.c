...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon2\\Encryption\\Security\\Uuid, Uuid5, phalcon2, encryption_security_uuid_uuid5, phalcon2_encryption_security_uuid_ce, phalcon2_encryption_security_uuid_uuid5_method_entry, 0);

	zephir_declare_class_constant_long(phalcon2_encryption_security_uuid_uuid5_ce, SL("TYPE"), 5);
