...
{
	ZEPHIR_REGISTER_CLASS(Phalcon2\\Encryption, Crypt, phalcon2, encryption_crypt, phalcon2_encryption_crypt_method_entry, 0);

	/**
	 * @var string
	 */
	zend_declare_property_string(phalcon2_encryption_crypt_ce, SL("authData"), "", ZEND_ACC_PROTECTED);
	/**
	 * @var string
	 */
	zend_declare_property_string(phalcon2_encryption_crypt_ce, SL("authTag"), "", ZEND_ACC_PROTECTED);
	/**
	 * @var int
	 */
	zend_declare_property_long(phalcon2_encryption_crypt_ce, SL("authTagLength"), 16, ZEND_ACC_PROTECTED);
	/**
	 * Available cipher methods.
	 *
	 * @var array
	 */
	zend_declare_property_null(phalcon2_encryption_crypt_ce, SL("availableCiphers"), ZEND_ACC_PROTECTED);
	/**
	 * @var string
	 */
	zend_declare_property_string(phalcon2_encryption_crypt_ce, SL("cipher"), "aes-256-cfb", ZEND_ACC_PROTECTED);
	/**
	 * The name of hashing algorithm.
	 *
	 * @var string
	 */
	zend_declare_property_string(phalcon2_encryption_crypt_ce, SL("hashAlgorithm"), "sha256", ZEND_ACC_PROTECTED);
	/**
	 * The cipher iv length.
	 *
	 * @var int
	 */
	zend_declare_property_long(phalcon2_encryption_crypt_ce, SL("ivLength"), 16, ZEND_ACC_PROTECTED);
	/**
	 * @var string
	 */
	zend_declare_property_string(phalcon2_encryption_crypt_ce, SL("key"), "", ZEND_ACC_PROTECTED);
	/**
	 * @var int
	 */
	zend_declare_property_long(phalcon2_encryption_crypt_ce, SL("padding"), 0, ZEND_ACC_PROTECTED);
	/**
	 * @var PadFactory
	 */
	zend_declare_property_null(phalcon2_encryption_crypt_ce, SL("padFactory"), ZEND_ACC_PROTECTED);
	/**
	 * Whether calculating message digest enabled or not.
	 *
	 * @var bool
	 */
	zend_declare_property_bool(phalcon2_encryption_crypt_ce, SL("useSigning"), 1, ZEND_ACC_PROTECTED);
	phalcon2_encryption_crypt_ce->create_object = zephir_init_properties_Phalcon2_Encryption_Crypt;
	/**
	 * Defaults
	 */
	zephir_declare_class_constant_string(phalcon2_encryption_crypt_ce, SL("DEFAULT_ALGORITHM"), "sha256");

	zephir_declare_class_constant_string(phalcon2_encryption_crypt_ce, SL("DEFAULT_CIPHER"), "aes-256-cfb");

	/**
	 * Padding
	 */
	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_ANSI_X_923"), 1);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_DEFAULT"), 0);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_ISO_10126"), 3);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_ISO_IEC_7816_4"), 4);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_PKCS7"), 2);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_SPACE"), 6);

	zephir_declare_class_constant_long(phalcon2_encryption_crypt_ce, SL("PADDING_ZERO"), 5);

	zend_class_implements(phalcon2_encryption_crypt_ce, 1, phalcon2_encryption_crypt_cryptinterface_ce);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 3)
		...
		Z_PARAM_OBJECT_OF_CLASS_OR_NULL(padFactory, zephir_get_internal_ce(SL("phalcon2\\encryption\\crypt\\padfactory")))
	...
	if (Z_TYPE_P(padFactory) == IS_NULL) {
		...
		object_init_ex(padFactory, phalcon2_encryption_crypt_padfactory_ce);
		ZEPHIR_CALL_METHOD(NULL, padFactory, "__construct", NULL, 21);
...
PHP_METHOD(Phalcon2_Encryption_Crypt, decrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&decryptKey)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Decryption key cannot be empty", "phalcon2/Encryption/Crypt.zep", 175);
		return;
	}
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&mode, this_ptr, "getmode", NULL, 22);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&blockSize, this_ptr, "getblocksize", NULL, 23, &mode);
	zephir_check_call_status();
	ZVAL_LONG(&_0, 0);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 24, &input, &_0, &ivLength, &_1);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$5, "");
		ZEPHIR_CALL_FUNCTION(&_3$$5, "hash", NULL, 25, &hashAlgorithm, &_2$$5, &__$true);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&hashLength);
		ZVAL_LONG(&hashLength, zephir_fast_strlen_ev(&_3$$5));
		ZEPHIR_INIT_NVAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "8bit");
		ZEPHIR_CALL_FUNCTION(&digest, "mb_substr", NULL, 24, &input, &ivLength, &hashLength, &_2$$5);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$5);
		zephir_add_function(&_4$$5, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 24, &input, &_4$$5, &__$null, &_2$$5);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_5$$6);
		ZVAL_STRING(&_5$$6, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 24, &input, &ivLength, &__$null, &_5$$6);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_7)) {
		ZEPHIR_CALL_FUNCTION(&_8$$7, "hash_hmac", NULL, 26, &hashAlgorithm, &padded, &decryptKey, &__$true);
		zephir_check_call_status();
		if (!ZEPHIR_IS_IDENTICAL(&digest, &_8$$7)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_mismatch_ce, "Hash does not match.", "phalcon2/Encryption/Crypt.zep", 224);
			return;
		}
	}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, decryptBase64)
{
	...
	if (safe) {
		...
		ZVAL_STRING(&_1$$3, "+/");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "strtr", NULL, 2, &input, &_0$$3, &_1$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_5, "base64_decode", NULL, 27, &input);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, encrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&encryptKey)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Encryption key cannot be empty", "phalcon2/Encryption/Crypt.zep", 282);
		return;
	}
	zephir_read_property(&_0, this_ptr, ZEND_STRL("cipher"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&cipher, &_0);
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&iv)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Cannot calculate Random Pseudo Bytes", "phalcon2/Encryption/Crypt.zep", 295);
		return;
	}
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&digest, "hash_hmac", NULL, 26, &_2$$6, &padded, &encryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, encryptBase64)
{
	...
	if (safe) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1$$3, "base64_encode", NULL, 1, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "+/");
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "-_");
		ZEPHIR_CALL_FUNCTION(&_4$$3, "strtr", NULL, 2, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 1, &_5);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, getAvailableHashAlgorithms)
{
	...
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac_algos", NULL, 28);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("hash_algos", NULL, 29);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, isValidDecryptLength)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "mb_strlen", NULL, 30, &input);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, setCipher)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getivlength", NULL, 31, &cipher);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, checkCipherHashIsAvailable)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&lower, "mb_strtolower", NULL, 32, &cipher);
	zephir_check_call_status();
	if (1 != zephir_array_isset(&available, &lower)) {
		ZEPHIR_INIT_VAR(&_1$$5);
		object_init_ex(&_1$$5, phalcon2_encryption_crypt_exception_exception_ce);
		ZEPHIR_INIT_VAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "The %s algorithm '%s' is not supported on this system.");
		ZEPHIR_CALL_FUNCTION(&_3$$5, "sprintf", NULL, 9, &_2$$5, &type, &cipher);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 33, &_3$$5);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$5, "phalcon2/Encryption/Crypt.zep", 608);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, cryptPadText)
{
	...
	ZVAL_STRING(&_2, "ecb");
	zephir_array_fast_append(&_1, &_2);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checkismode", NULL, 34, &_1, &mode);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_3$$3, "mb_strlen", NULL, 30, &input);
		zephir_check_call_status();
		...
		if (_4$$3) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Padding size cannot be less than 0 or greater than 256", "phalcon2/Encryption/Crypt.zep", 641);
			return;
		}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, cryptUnpadText)
{
	...
	if (_1) {
		...
		ZVAL_STRING(&_4, "ecb");
		zephir_array_fast_append(&_3, &_4);
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkismode", NULL, 34, &_3, &mode);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon2_Encryption_Crypt, decryptGcmCcmAuth)
{
	...
	ZVAL_STRING(&_3, "gcm");
	zephir_array_fast_append(&_2, &_3);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checkismode", NULL, 34, &_2, &mode);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		ZVAL_LONG(&_4$$3, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 35, &encrypted, &cipher, &decryptKey, &_4$$3, &iv, &authTag, &authData);
		zephir_check_call_status();
	} else {
		ZVAL_LONG(&_6$$4, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 35, &cipherText, &cipher, &decryptKey, &_6$$4, &iv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&decrypted)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Could not decrypt data", "phalcon2/Encryption/Crypt.zep", 782);
		return;
	}
	RETURN_CCTOR(&decrypted);
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, encryptGcmCcm)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		if (1 == ZEPHIR_IS_EMPTY(&authData)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Auth data must be provided when using AEAD mode", "phalcon2/Encryption/Crypt.zep", 841);
			return;
		}
		...
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 36, &padded, &cipher, &encryptKey, &_4$$3, &iv, &authTag, &authData, &authTagLength);
		ZEPHIR_UNREF(&authTag);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("authTag"), &authTag);
	} else {
		ZVAL_LONG(&_5$$5, 1);
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 36, &padded, &cipher, &encryptKey, &_5$$5, &iv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&encrypted)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Could not encrypt data", "phalcon2/Encryption/Crypt.zep", 870);
		return;
	}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, initializeAvailableCiphers)
{
	...
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "This class requires the openssl extension for PHP", "phalcon2/Encryption/Crypt.zep", 892);
		return;
	}
	ZEPHIR_CALL_FUNCTION(&available, "openssl_get_cipher_methods", NULL, 37, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&allowed);
	array_init(&allowed);
	zephir_is_iterable(&available, 0, "phalcon2/Encryption/Crypt.zep", 909);
...
PHP_METHOD(Phalcon2_Encryption_Crypt, getBlockSize)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
	ZEPHIR_CALL_FUNCTION(&_4, "str_ireplace", NULL, 38, &_1, &_3, &_2);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getivlength", NULL, 31, &_4);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, getIvLength)
{
	...
	ZEPHIR_CALL_FUNCTION(&length, "openssl_cipher_iv_length", NULL, 39, &cipher);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&length)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon2_encryption_crypt_exception_exception_ce, "Cannot calculate the initialization vector (IV) length of the cipher", "phalcon2/Encryption/Crypt.zep", 962);
		return;
	}
	RETURN_CCTOR(&length);
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, getMode)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "-");
	ZEPHIR_CALL_FUNCTION(&_2, "strrpos", NULL, 40, &_0, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 32, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, phpOpensslCipherIvLength)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 39, &cipher);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon2_Encryption_Crypt, phpOpensslRandomPseudoBytes)
{
	...
	ZVAL_LONG(&_0, length);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 41, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
